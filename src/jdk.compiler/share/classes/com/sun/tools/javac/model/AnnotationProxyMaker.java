...
public class AnnotationProxyMaker {
    ...
    private Annotation generateAnnotation() {
        return nbjavac.sun.annotation.AnnotationParser.annotationForMap(annoType,
    ...
    private class ValueVisitor implements Attribute.Visitor {
        ...
        Object getValue(Attribute attr) {
            ...
            attr.accept(this);
            if (!(value instanceof nbjavac.sun.annotation.ExceptionProxy) &&
                !nbjavac.sun.annotation.AnnotationType.invocationHandlerReturnType(returnClass)
                                                        .isInstance(value)) {
            ...
            if (elemName.equals(elemName.table.names.java_lang_Class)) {   // Class[]
                ...
                try {
                    ...
                    for (int i = 0; i < len; i++) {
                        ...
                        if (value == null || value instanceof nbjavac.sun.annotation.ExceptionProxy) {
                            return;
                        }
                        try {
        ...
        public void visitEnum(Attribute.Enum e) {
            if (returnClass.isEnum()) {
                ...
                try {
                    ...
                    value = new nbjavac.sun.annotation.EnumConstantNotPresentExceptionProxy(
        ...
        private void typeMismatch(Method method, final Attribute attr) {
            class AnnotationTypeMismatchExceptionProxy extends nbjavac.sun.annotation.ExceptionProxy {
     ...
     * type.
     */
    private static final class MirroredTypeExceptionProxy extends nbjavac.sun.annotation.ExceptionProxy {
        static final long serialVersionUID = 269;
     ...
     * types.
     */
    private static final class MirroredTypesExceptionProxy extends nbjavac.sun.annotation.ExceptionProxy {
        static final long serialVersionUID = 269;
