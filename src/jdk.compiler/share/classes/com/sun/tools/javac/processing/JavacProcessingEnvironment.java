...
public class JavacProcessingEnvironment implements ProcessingEnvironment, Closeable {
        ...
        try {
            if (fileManager.hasLocation(ANNOTATION_PROCESSOR_MODULE_PATH)) {
                ...
                if (options.isSet("accessInternalAPI"))
                    ModuleHelper.addExports(ModuleWrapper.getModule(getClass()), ModuleWrapper.getUnnamedModule(processorClassLoader));
    ...
    public <S> ServiceLoader<S> getServiceLoader(Class<S> service) {
        if (fileManager.hasLocation(ANNOTATION_PROCESSOR_MODULE_PATH)) {
            ...
            return ServiceLoaderWrapper.loadWithClassLoader(service, getProcessorClassLoader());
        }
    }
    ...
    private class ServiceIterator implements Iterator<Processor> {
        ...
        ServiceIterator(ClassLoader classLoader, Log log) {
            ...
            try {
                try {
                    loader = ServiceLoaderWrapper.loadWithClassLoader(Processor.class, classLoader);
